...
2. Add automated watering based on configured threshold
3. Consider switching to binary transfers instead of JSON packets
4. Migrate from SQLite to MySQL or PostgreSQL
5. Add another node type (probably ESP32)
6. Fix all current issues
