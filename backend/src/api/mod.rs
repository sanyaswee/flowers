...
#[openapi(
    info(
        title = "Flowers API",
        description = r#"
**IMPORTANT NOTE:** the docs were automatically generated by [utoipa](https://github.com/juhaku/utoipa), so the values in example outputs/inputs may be weird, especially for numeric fields.
Please verify them with "Try it out" button or take a look at the source code.
        "#
    ),
    paths(
        // Getters
